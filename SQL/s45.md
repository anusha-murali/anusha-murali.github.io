...
1. If more than one student created the same number of challenges and if this count is **strictly less** than $N$, then exclude all those students.
2. However, if more than one student created the same number of challenges and if this count is **equal** to the maximum number of challenges created, $N$, then include all these students who created the maximum number of challenges $N$.
