...
Bellman-Ford algorithm is useful when the graph has negative edge weights (of course, negative cycles are still not allowed). It has the following applications:
