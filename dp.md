...
> **Example**: For example, consider the price list, $p = [0, 2, 7, 8, 10]$. This indicates the price of a 0 length rod is \\$0, the price of length 1 is \\$2, the price of length 2 is \\$7 and so on. Not sure if this works \$45
