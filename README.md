...
The probability the first two people have different birthdays is $ \left (1−\frac{1}{365} \right )$. So, the probability that all of the first $k$ people have different birthdays is,
